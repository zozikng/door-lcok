...
/**
 * @description: influxdb操作工具类
 * @program: influxdbdemo
 * @author: zzk
 * @created: 2021/11/30 20:49
 */
@Component
public class InfluxdbUtil {
    ...
    //measurement
    private final String measurement = "cabinetstate";
    ...
    public boolean insertOne(Object obj){
        ...
        //构建
        Point.Builder builder = Point.measurement(measurement.name())/*.time (LocalDateTime.now ().plusHours (8).toInstant (ZoneOffset.of ("+8")).toEpochMilli (), TimeUnit.MICROSECONDS)*/;
        // 获取对象属性
